...
def decode_predictions(score, geo):
...
def text_recognition_by_region(region):
...
def detect_text(vs, frameWidth, frameHeight, ratioWidth, ratioHeight):
    while True:
        frame = vs.read()
        ...
        for (startX, startY, endX, endY) in boxes:
            ...
            if roi is not None:
                text_recognition_by_region(roi)
...
if __name__ == "__main__":
    ...
    detect_text(videoStream, W, H, rW, rH)
